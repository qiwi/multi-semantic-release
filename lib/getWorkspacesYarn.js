...
function getWorkspacesYarn(cwd, ignorePackages = null) {
	...
	const _ignorePackages = _setIgnoredPackages(packages, ignorePackages);
 ...
 * @param {string[]} packages  Manifest packages set on workspaces attribute.
 * @param {string[]|null} ignorePackages (Optional) Packages to be ignored passed via cli.
 * @returns {string[]} An array packages to be ignored in the semver release process.
 */
function _setIgnoredPackages(packages, ignorePackages = null) {
